...
## Shared module index & Systems

Full per-module systems reference — the `src/shared/` module index and the
`src/server/` / `src/client/` systems table — lives in
[`docs/SYSTEMS.md`](docs/SYSTEMS.md). Read it when working on a specific module
or system.
